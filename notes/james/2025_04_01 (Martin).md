- Lots of journals accept code papers, as long as it's used by people studying the relevant subject matter.
...
- Program needs to be able to handle mutations, variants, et cetera.
	...
	- Probabilistic approaches can result in incorrect assemblies.
		...
		- "Eighteen-[primer](https://en.wikipedia.org/wiki/Primer_(molecular_biology)) design theory."
...
- Indexes substrings of genomes are "ranges."
...
- Action steps:
	1. James gets data.
		...
		3. Something else?
	2. Rewrite in Python?
		1. Move back to compiled language if needed for performance.
...
- The goal is to not throw out things/annotations you actually want.
	...
	- Trinity doesn't know what virus X is, that's only gonna come after your BLAST search?
		- So why did Trinity throw out an overlap?
